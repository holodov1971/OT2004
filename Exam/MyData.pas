...
var {новая версия}
    ...
    NameExam:string;
    PasswAD,PasswExam,PasswRab,OldPass:string;
    YesPasswAD,YesPasswKat,YesPasswTem:boolean;
    ModeExam:integer; {0 - случ обр. 1 - случ билет 2 - фикс билет}
//    PasswProfotb,PasswTren,PasswServ,PasswAll, PasswExam:st10;
var DataPath, GlPathDius, TBPath, ServerIB :string;
    BkUpDir: string;
    IniFile: TIniFile;
